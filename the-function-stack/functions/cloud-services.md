...
<div align="left"><figure><img src="../../.gitbook/assets/image (69).png" alt="" width="375"><figcaption><p>Configure OpenSearch connection using IAM or internal user database credentials.</p></figcaption></figure></div>
